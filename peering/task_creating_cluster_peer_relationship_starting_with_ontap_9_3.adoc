...
[role="lead"]
2 つのクラスタ間にクラスタピア関係を作成するには、システム生成のパスフレーズおよびリモートクラスタのクラスタ間 LIF の IP アドレスを指定します。
...
. ソースクラスタで、手順で生成したパスフレーズを入力します <<STEP_F18C02A36D1D445CA930399D2E9AAB0A,#step_F18C02A36D1D445CA930399D2E9AAB0A>>。
